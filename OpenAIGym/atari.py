...
dqnarg.add_argument("--final_eps_frame", type=float, default=10000, help="The number of frames over which the initial value of e is linearly annealed to its final.")
dqnarg.add_argument("--clip_delta", type=float, default=1, help="Clip error term in update between this number and its negative.")
dqnarg.add_argument("--steps", type=int, default=100, help="Copy main network to target network after this many steps.")
dqnarg.add_argument("--train_steps", type=int, default=5000, help="Number of training steps.")
...
dqnarg.add_argument("--save_weights", type=int, default=1000, help="Save the mondel after this many steps.")
